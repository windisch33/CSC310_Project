...
public class MergeSort {
	...
	/**
	 * takes an array and copies half of it to array b and half to array c sends
	 * b and c to merge sort until arrays are length 1 then calls merge method
	 * on the three arrays
	 * 
	 * @param arrayA
	...
	/**
	 * merges the three arrays into ascending order
	 * 
	 * @param arrayB
	 *            the first smaller array
	 * @param arrayC
	 *            the second smaller array
	 * @param arrayA
	 *            the target array
	 */
